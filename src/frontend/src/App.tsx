...
function Navbar() {
  ...
  const mutedColor = scrolled ? "text-muted-foreground" : "text-white/70";
        ...
        <div className="hidden xl:flex items-center gap-1 flex-1 justify-center">
          {NAV_LINKS.map((link) => (
            <button
              ...
              className={`px-3 py-1.5 text-sm font-medium rounded-lg hover:bg-white/10 transition-colors ${textColor}`}
            >
              {link.label}
            </button>
          ))}
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="xl:hidden bg-card/95 backdrop-blur-md border-b border-border"
          >
            <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-1">
              {NAV_LINKS.map((link) => (
                <button
                  ...
                  className="text-left px-3 py-2 text-sm font-medium text-foreground hover:bg-muted rounded-lg transition-colors"
                >
                  {link.label}
                </button>
              ))}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.18 0.04 55) 0%, oklch(0.35 0.08 55) 50%, oklch(0.52 0.13 55) 100%)",
        }}
      />
      {/* Overlay */}
      ...
      {/* Logo badge top-left */}
      <div className="absolute top-20 left-4 w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-white/40 bg-amber-700/60 flex items-center justify-center text-3xl z-20">
        🍽️
      </div>
      ...
      >
        ...
        <motion.p
          variants={fadeUp}
          className="text-amber-200 text-lg sm:text-xl font-medium mb-3"
        >
        ...
        >
          <button
            ...
            className="bg-amber-600 hover:bg-amber-700 text-white px-8 py-3 rounded-full font-semibold text-base transition-colors"
          >
            View Menu
          </button>
          <a
            ...
            className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-8 py-3 rounded-full font-semibold text-base transition-colors"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.p
              variants={fadeUp}
              className="text-amber-700 uppercase tracking-widest text-sm font-semibold mb-3"
            >
              ✦ Our Story
            </motion.p>
            <motion.h2
              variants={fadeUp}
              className="font-display text-4xl lg:text-5xl font-bold text-foreground mb-5 leading-tight"
            >
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="rounded-3xl border-4 border-amber-200 shadow-warm-lg h-80 lg:h-[480px] bg-amber-50 flex items-center justify-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          {cards.map((card, i) => (
            ...
            >
              <div className="h-48 bg-amber-50 border-b-2 border-dashed border-amber-200 flex flex-col items-center justify-center gap-2">
        ...
        <div className="text-center">
          <a
            ...
            className="inline-flex items-center gap-2 bg-amber-700 hover:bg-amber-800 text-white px-8 py-3 rounded-full font-semibold transition-colors"
          >
    ...
    <section id="menu" className="section-white py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <motion.h2
            variants={fadeUp}
            className="font-display text-4xl lg:text-5xl font-bold text-foreground mb-3"
          >
            Our Menu
          </motion.h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mb-10">
          {(MENU_ITEMS[activeCategory] || []).map((item, i) => (
            ...
            >
              <div className="h-44 bg-amber-50 border-b-2 border-dashed border-amber-200 flex flex-col items-center justify-center gap-1">
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 space-y-4 mb-10">
          {photos.map((photo, i) => (
            <motion.div
              ...
              className={`break-inside-avoid overflow-hidden rounded-xl shadow-md ${photo.h} bg-amber-50 border-2 border-dashed border-amber-300 flex flex-col items-center justify-center gap-2`}
            >
              <span className="text-4xl">📸</span>
              <span className="text-amber-600 text-sm font-medium">
                Photo Coming Soon
              </span>
              <span className="text-amber-400 text-xs text-center px-4">
                {photo.alt}
              </span>
            </motion.div>
          ))}
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3 mb-5">
                  <a
                    href={b.tel}
                    className="flex items-center gap-2 bg-amber-700 hover:bg-amber-800 text-white px-4 py-2 rounded-full text-sm font-semibold transition-colors"
                  >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          {decorations.map((d, i) => (
            ...
            >
              <div className="h-44 bg-amber-50 border-b-2 border-dashed border-amber-200 flex flex-col items-center justify-center gap-2">
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-green-500 hover:bg-green-600 text-white text-xs px-3 py-1.5 rounded-full font-semibold transition-colors"
                  >
                    Book Now
                  </a>
                </div>
  ...
  const socials = [
    {
      ...
      btnClass: "bg-gradient-to-r from-purple-500 to-pink-500 hover:opacity-90",
                    ...
                    <div>
                      ...
                      {item.href ? (
                        <a
                          ...
                          className="text-sm text-foreground hover:text-amber-700 transition-colors font-medium"
                          target={
              ...
              <div className="flex flex-col gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-border rounded-xl px-4 py-2.5 text-sm bg-background focus:outline-none focus:ring-2 focus:ring-amber-600/30"
                  />
                </div>
                <div>
                  <label
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full border border-border rounded-xl px-4 py-2.5 text-sm bg-background focus:outline-none focus:ring-2 focus:ring-amber-600/30 resize-none"
                  />
                </div>
                <button
                  type="button"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <a
            ...
            className="text-amber-400 hover:text-amber-300 font-medium transition-colors mb-6"
          >
            📞 +91 99817 16485
          </a>
